...
\begin{proof}
  ...
  \begin{center}
    \begin{tikzcd}
      \Gal(K_{\pi, n+1}) \arrow{r}{\psi_{n+1}} \arrow{d}{\text{restriction}}& \O_K^\times/U_K^{(n+1)} \arrow{d}{\text{natural projn}}\\
      \Gal(K_{\pi, n}) \arrow{r}{\psi_n} & \O_K^\times/U_K^{(n)}
    \end{tikzcd}
  \end{center}
...
\begin{center}
  \begin{tikzcd}
    K^\times \arrow{r}{\Art_K} \arrow{d}{u\pi^n\mapsto (n,u)} & \Gal(K^{ab}/K)\\
    \Z\times \O_K^\times \arrow[swap]{r}{(n,u)\mapsto (\Fr^n_{K^{ur}/K}, \psi^{-1}(u))} & \Gal(K^{ur}/K)\times \Gal(K_{\pi, \infty}/K) \arrow{u}
  \end{tikzcd}
\end{center}
